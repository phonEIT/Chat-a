...
public class StatisticsJFrame extends javax.swing.JFrame {
    ...
    public void init() {
        ...
        jLabel4.setText(String.valueOf(dao.totalRevenue()));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Long cafe statistics ");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        for (double i = 0.1; i <= 1.0; i += 0.1) {
            ...
            try {
                ...
                Logger.getLogger(ViewOdersJFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
