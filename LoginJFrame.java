...
public class LoginJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 300, 120, -1));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 300, 120, -1));

        jPasswordField1.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jPanel1.add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 338, 34));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 230, 36, 34));
        ...
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 230, -1, 30));
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 350, -1, -1));
        ...
        if (isEmpty()) {
            ...
            if (dao.login(username, password)) {
                ...
                if (dao.getMaxRowAdminTable() != 1) {
                    ...
                    JOptionPane.showMessageDialog(this, "Không có quản trị viên trong bảng \nBạn cần đăng nhập trước.", "Đăng nhập thất bại!", 2);
                    new SignUpJFrame().setVisible(true);
                    setVisible(false);
                }
            } else {
                // Nếu sai
                JOptionPane.showMessageDialog(this, "Tên đăng nhập hoặc mật khẩu không đúng.", "Đăng nhập thất bại!", 2);
            }
        }
